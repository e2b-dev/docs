...
<Note>
  <b><sup>*</sup></b> Pro plan default is 100 concurrent sandboxes. Higher concurrency of up to 1,100 is available as a separate add-on that can be purchased at <Link to="https://e2b.dev/dashboard/?tab=billing">here</Link>.
</Note>
