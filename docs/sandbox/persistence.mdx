...
<CodeGroup>
```js JavaScript & TypeScript highlight={9-10}
import "dotenv/config"
import { Sandbox } from '@e2b/code-interpreter'
...
<CodeGroup>
```js JavaScript & TypeScript highlight={13-14}
import "dotenv/config"
import { Sandbox } from '@e2b/code-interpreter'
...
<CodeGroup>
```js JavaScript & TypeScript highlight={5,8}
import "dotenv/config"
...
<CodeGroup>
```js JavaScript & TypeScript highlight={12,15}
import "dotenv/config"
import { Sandbox } from '@e2b/code-interpreter'
