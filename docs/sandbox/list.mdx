...
<CodeGroup>
    ```js JavaScript & TypeScript highlight={7,12,15,25}
    ...
    ```
    ```python Python highlight={7,11,14,24}
...
<CodeGroup>
    ```js JavaScript & TypeScript highlight={10,14}
    import "dotenv/config"
...
<CodeGroup>
    ```js JavaScript & TypeScript highlight={7-9,16,19}
    import "dotenv/config"
    import { Sandbox } from '@e2b/code-interpreter'
    ...
    const sandboxes = await paginator.nextItems()
    ```
    ```python Python highlight={8-10,18-19}
    from dotenv import load_dotenv
    from e2b_code_interpreter import Sandbox, SandboxQuery, SandboxState
...
<CodeGroup>
    ```js JavaScript & TypeScript highlight={5-6,17}
    import "dotenv/config"
    import { Sandbox } from '@e2b/code-interpreter'
    ...
    ```
    ```python Python  highlight={7-8,15}
    from dotenv import load_dotenv
...
<CodeGroup>
    ```js JavaScript & TypeScript highlight={12}
    import "dotenv/config"
    import { Sandbox } from '@e2b/code-interpreter'
...
<CodeGroup>
    ```js JavaScript & TypeScript highlight={7-9,16}
    import "dotenv/config"
    import { Sandbox } from '@e2b/code-interpreter'
    ...
    ```
    ```python Python highlight={9-11,19-20}
    from dotenv import load_dotenv
    from e2b_code_interpreter import Sandbox
