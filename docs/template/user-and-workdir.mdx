...
await Template.build(template, {
  alias: "customer-user-template", 
  onBuildLogs: defaultBuildLogger()
})


// index.ts
const sbx = await Sandbox.create(alias="custom-user-template")
...
Template.build(template, 
    alias="custom-user-template", 
    on_build_logs=default_build_logger()
)


# main.py
sbx = Sandbox.create(alias="custom-user-template")
