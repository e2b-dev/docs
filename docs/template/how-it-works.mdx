...
You can browse our kernel sources in the [kernel repository](https://github.com/e2b-dev/fc-kernels/) or review the [kernel configuration files](https://github.com/e2b-dev/fc-kernels/tree/main/configs) used during the build.