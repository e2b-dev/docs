...
1. [E2B CLI](/docs/legacy/cli/installation)
...
<Note>
You need to have an existing E2B account to login. Sign up [here](/docs/legacy/getting-started/api-key).
</Note>
...
We use this Dockerfile as the [template file](/docs/legacy/sandbox/templates/template-file).
...
<Note>
[Pro users](/docs/legacy/pricing) can use the `--cpu-count=` ([docs](/docs/legacy/cli/commands#template-build)) and `--memory-mb=` ([docs](/docs/legacy/cli/commands#template-build)) flags to customize the sandbox compute.
Read more about the compute [here](/docs/legacy/sandbox/compute).
</Note>
...
Now you can use the [E2B SDK](/docs/legacy/getting-started/installation) to spawn & control your new custom sandbox.
