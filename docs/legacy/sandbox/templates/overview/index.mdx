...
Read more about E2B Sandboxes [here](/docs/legacy/sandbox/overview).
</Note>
...
<Note>
Follow our [guide](/docs/legacy/guide/custom-sandbox) on how to create a custom sandbox.
</Note>

1. You build a custom sandbox by creating the [Sandbox Template](/docs/legacy/sandbox/templates/template-file) which is a Dockerfile describing the environment of your sandbox.
