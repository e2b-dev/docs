...
<Icon icon="check" /> [Python & Node.js SDK](/docs/legacy/getting-started/installation) for controling the sandbox's 

<Icon icon="check" /> [filesystem](/docs/legacy/sandbox/api/filesystem), 

<Icon icon="check" /> [processes](/docs/legacy/sandbox/api/process), and more.Support for up to 24h long-running sandbox sessionsAbility to 

<Icon icon="check" /> [upload files](/docs/legacy/sandbox/api/upload) to the sandbox and 

<Icon icon="check" /> [download files](/docs/legacy/sandbox/api/download) from the sandbox,
...
Inside this sandbox, your AI app can [run code and start any programs](/docs/legacy/sandbox/api/process), access the internet to download or upload data, use the [filesystem](/docs/legacy/sandbox/api/filesystem), start long running processes such as web servers, and more.
You can also [upload](/docs/legacy/sandbox/api/upload) to sandbox and [download](/docs/legacy/sandbox/api/upload) from sandbox any file you want.

To start and control the sandbox, use the [E2B SDK](/docs/legacy/getting-started/installation) for Python or JavaScript.
...
<Note>
Make sure you have the `E2B_API_KEY` environment variable set with your [API key](/docs/legacy/getting-started/api-key).
</Note>
