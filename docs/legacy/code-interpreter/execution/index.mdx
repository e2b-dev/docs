...
- `kernel id`: The ID of the kernel to execute the code on. If not provided, the default kernel is used. See [here](/docs/legacy/code-interpreter/kernels) for more info on kernels.
