...
- Customize your [sandbox compute](/docs/legacy/sandbox/compute)
- Up to 24 hours sandbox session length
- Up to 100 concurrently running sandboxes


If you need any additional features or resources, please [reach out to us](/docs/legacy/getting-help) with your use case.
...
To customize your sandbox compute, you need to build your custom sandbox template using the [E2B CLI](/docs/legacy/cli/installation).
Run [`e2b template build`](/docs/legacy/cli/commands#template-build) and specify the `--cpu-count` and `--memory-mb` options.
...
<br/>
[Let us know](/docs/legacy/getting-help) if you need more powerful compute.
